    ...
    : ICommandHandler
{
    ...
    private static string BuildPrompt(string meal, string extras)
    {
        return $"""
            ...
            Форматирование должно быть для Telegram чётким и структурированным, с использованием эмодзи для визуального разделения пунктов. Ответ должен быть лаконичным, без лишних объяснений, только конкретные рекомендации.
